...
public class Bedinterminal_Scannen extends JPanel {
	
	private GuiBedinterminal Terminal;

	public Bedinterminal_Scannen(GuiBedinterminal t) {
		Terminal = t;
		...
		JButton btnAlleUnbekannten = new JButton("Alle Unbekannten");
		btnAlleUnbekannten.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			}
		});
		...
		JLabel lblWonachWollenSie = new JLabel("Welche Pflanzen wollen Sie Scannen?");
				...
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(groupLayout.createSequentialGroup()
							...
							.addGap(10)
							.addComponent(btnAlleUnbekannten, GroupLayout.DEFAULT_SIZE, 211, Short.MAX_VALUE)
							.addContainerGap())
						.addGroup(groupLayout.createSequentialGroup()
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE, false)
						.addComponent(btnArt)
						.addComponent(btnAlleUnbekannten))
