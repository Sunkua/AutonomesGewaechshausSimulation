...
public class Roboterleitsystem extends Observable implements Observer {
	...
	public void roboterHinzufuegen(Pflanzenverwaltung pflanzenverwaltung) {
		try {
			...
			Logging.log(this.getClass().getName(), Level.WARNING,
					"Keine freie Position gefunden. Roboter konnte nicht hinzugefügt werden");
		}
	}
	...
	/**
	 * Führt das nächste Runnable aus der RunnableQueue aus, falls eines
	 * existiert und das vorher ausgeführte terminiert ist
	 */
	...
	/**
	 * Liest den Zustand eines Roboterleitsystems aus einer Datei und spielt
	 * diesen ein
	 */
	public void roboterLeitsystemZustandAusDateiLesen() {
		try {
			...
			Roboterleitsystem roboterleitsystem = (Roboterleitsystem) m
					.unmarshal(new FileReader("Roboterleitsystem_Zustand.xml"));
