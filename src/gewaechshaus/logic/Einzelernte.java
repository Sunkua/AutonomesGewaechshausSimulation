...
public class Einzelernte extends Unterauftrag {
	 ...
	 *
	 * @param ep
	 *            Die Pflanze, die geerntet werden sollen
	 * @param roboterleitsystem
	 *            Das Roboterleitsystem des Gewächshauses
	 */
	...
	/**
	 * Führt den aktuellen Unterauftrag bzgl. des aktuellen Zustandes aus (Wird
	 * mehrfach aufgerufen, bis der Unterauftragsstatus beendet oder abgebrochen
	 * ist
	 *
	 * @param roboter
	...
	public void ausfuehren(Roboter roboter) {
		...
		case 0:
			...
			// erneut ob 0, falls ja dann warte
	 ...
	 *
	 * @param roboter
	 *            Robote der zu einer seiner Nachbarpositionen fahren soll
	 */
