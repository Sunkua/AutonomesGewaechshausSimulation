...
public class Position implements Comparable<Position> {
	 ...
	 *
	 * @param spalte
	 *            Spaltenkoordinate (Virtuelle X-Koordinate, muss >= 0 sein)
	 * @param zeile
	 *            Zeilenkoordinate (Virtuelle Y-Koordinate, muss >= 0 sein)
	 */
	 ...
	 *
	 * @param x
	 *            X-Koordinate im Raum (Muss >= 0 sein) entspricht der
	 *            virtuellen Spaltenkoordinate
	 * @param y
	 *            Y-Koordinate im Raum (Muss >= 0 sein) entspricht der
	 ...
	 *
	 * @param maxReihen
	 *            Reihenanzahl des Gitters (Maximal Y-Koordinate + 1)
	 * @param maxHoehe
	 *            Höhe des Gewächshauses von oben betrachtet in m
	 */
	 ...
	 *
	 * @param maxSpalten
	 *            Spaltenanzahl im Gitter (Maximale X-Koordinate +1)
	 * @param maxBreite
	 *            Breite des Gewächshauses von oben betrachtet in m
	 */
