...
public class Abladestation extends Observable {
	...
	private AbladestationStatus status = AbladestationStatus.frei; // TODO Was
																	// ist
																	// Status?
	...
	/**
	 * Initialisiert eine Abladestation ohne Ablagetyp, Art und leerem
	 * Füllstand.
	 *
	 * @param position
	 *            Position im Gewächtshaus
	 */
	...
	/**
	 * Fügt der Abladestation eine Pflanzenart hinzu, für die Sie verantwortlich
	 * ist
	 *
	 * @param pArt
	 ...
	 *
	 * @param pArt
	 *            Pflanzenart die entfernt werden soll
	 */
	public void pflanzenArtEntfernen(PflanzenArt pArt) {
		try {
			...
			Logging.log(this.getClass().getName(), Level.WARNING,
					"Pflanzenart nicht im Set der Abladestation vorhanden");
		}
	}
	 ...
	 *
	 * @param pArt
	 *            die Pflanzenart die abgeladen wird
	 */
	 ...
	 *
	 * @param as
	 *            Status, den die Abladestation haben soll
	 */
