...
/**
 * Klasse zum Zusammenbau von komplexen Aufträgen
 */
public class Auftragsgenerator {
	 ...
	 *
	 * @param pVerwaltung
	 *            Pflanzenverwaltung um Referenzen auf die Pflanzen zu haben
	 * @param roboterleitsystem
	 *            Leitsystem um einem erstellten Auftrag das Leitsystem
	 *            zuzuweisen
	 * @param uhr
	 *            Uhr zum triggern der Ereignisse im jeweiligen Auftrag
	 */
	...
	/**
	 * Gibt einen Auftrag zurück, der eine Liste von Unteraufträgen enthält, die
	 * Pflanzen einer Art scannen
	 *
	 * @param pArt
	 *            die Pflanzenart, die gescannt werden soll
	...
	/**
	 * Gibt einen Auftrag zurück, der eine Liste von Unteraufträgen enthält, die
	 * Pflanzen mit einem bestimmten Status scannen
	 *
	 * @param pStatus
	 *            Status der Pflanzen die gescannt werden sollen
	 * @return Auftrag mit entsprechenden Unteraufträgen
	 */
	...
	/**
	 * Gibt einen Auftrag zurück, der eine Liste von Unteraufträgen enthält, die
	 * Pflanzen einer Art ernten
	 *
	 * @param pflanzenArt
	 *            Die Art der Pflanzen die geerntet werden sollen
	 * @return Auftrag mit entsprechenden Unteraufträgen
	 */
	 ...
	 *
	 * @param pStatus
	 *            Der Status der Pflanzen die geerntet werden sollen
	 * @return Auftrag mit entsprechenden Unteraufträgen
	 */
