...
public class NummerFeld extends TextField {
	 ...
	 * 
	 * @param start
	 *            Anfang für die Ersetzung, muss größer als Null sein
	 * @param end
	 *            Ende für die Ersetzung
	 * @param text
	 *            Text, der in dem Bereich ersetzt werden soll
	 */
	@Override
	 ...
	 * 
	 * @param text
	 *            Text, durch welchen Ersetzt werden soll
	 */
	@Override
