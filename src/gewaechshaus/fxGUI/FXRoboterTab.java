...
public class FXRoboterTab extends Tab {
    ...
    public FXRoboterTab(Roboterleitsystem r) {
        ...
        for (Roboter robot : roboterleitsystem.getRoboter()) {
            ...
            RobotRecord rec = new RobotRecord(robot.getID().toString(), robot.getPosition().toString(),
                    unterauftragAlsString(robot.getUnterauftrag()), robot.getLadestand(), robot.getFüllstandString());
            robotList.add(rec);
        }
     ...
     *
     * @param r zu aktualisierender Roboter
     */
     ...
     *
     * @param uAuftrag zu wandelnder Auftrag
