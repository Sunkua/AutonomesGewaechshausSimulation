...
public class PflanzenverwaltungTest {
	...
	/*
	 * @Test public void pflanzeHinzufuegen() throws Exception {
	 * pv.pflanzeHinzufuegen(ep);
	 * assertEquals(pv.holePflanzeVonPosition(ep.getPosition()), ep); }
	 * 
	 * @Test(expected = Exception.class) public void
	 * pflanze_an_ungültiger_position_hinzufuegen() throws Exception {
	 * ep.setPosition(new Position(15, 15)); pv.pflanzeHinzufuegen(ep); }
	 * 
	 * @Test(expected = Exception.class) public void
	 * pflanze_entfernen_und_Pflanze_von_selber_Position_holen() throws
	 * Exception { pv.pflanzeHinzufuegen(ep);
